...
export const ContactSection = () => {
    ...
    const handleSubmit = () =>{
        ...
        setTimeout(() => {
                toast({
                    title: "Message sent!",
                    description: "Thank you for your message. I''l get back to you soon.",
                });
    ...
    return <section id="contact" className="py-24 px-4 relative bg-secondary/35">
                    ...
                    <div className="space-y-6 justify-center">
                        <div className="flex items-start space-x-4">
                            ...
                            <div className="">
                                    ...
                                    <a href="markusbohorquez23@gmail.com"
                ...
                <div className="bg-card p-8 rounded-lg shadow-xs" onSubmit={handleSubmit}>
                    ...
                    <form className="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="message" name="message" required className="w-full px-4 py-3 rounded-md border border-input bg-background focus:outlind-hidden focus:ring-2 focus:ring-primary"
